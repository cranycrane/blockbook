...
# -------------------- CLI arguments --------------------
parser = argparse.ArgumentParser(description="Plot CPU vs IO-wait from Blockbook benchmark CSV.")
parser.add_argument("--csv", required=True, help="Input CSV file (e.g. systemSeq-Tron.csv)")
parser.add_argument("--out", required=True, help="Output PNG file (e.g. graphSeq-Tron.png)")
